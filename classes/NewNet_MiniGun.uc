...
DefaultProperties
{
    FireModeClass(0)=class'UTCompv17asrc.NewNet_MiniGunFire'
    FireModeClass(1)=class'UTCompv17asrc.NewNet_MiniGunAltFire'
    PickupClass=Class'UTCompv17asrc.NewNet_MiniGunPickup'
}
