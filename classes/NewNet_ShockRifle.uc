...
DefaultProperties
{
    FireModeClass(0)=class'UTCompv17asrc.NewNet_ShockBeamFire'
    FireModeClass(1)=class'UTCompv17asrc.NewNet_ShockProjFire'
    PickupClass=Class'UTCompv17asrc.NewNet_ShockRiflePickup'
}
