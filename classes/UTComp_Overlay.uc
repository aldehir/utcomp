...
// altered/recoded by Aaron 'Lotus' Everitt for use in UTCompv17c
//-----------------------------------------------------------
...
function PostRender( canvas Canvas )
{
  ...
  /*     HealthOffset=Canvas.ClipX*0.16;
   ...
   if(ViewPortOwner.Actor.Level.TimeSeconds<OnJoinMessageDrawTime)
   {
       ...
       Canvas.DrawText("UTComp "$MakeColorCode(class'Hud'.Default.GoldColor)$"1.7c"$MakeColorCode(InfoTextColor)$".");
