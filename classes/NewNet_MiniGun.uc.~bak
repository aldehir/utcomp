...
DefaultProperties
{
    FireModeClass(0)=class'UTCompv17c.NewNet_MiniGunFire'
    FireModeClass(1)=class'UTCompv17c.NewNet_MiniGunAltFire'
    PickupClass=Class'UTCompv17c.NewNet_MiniGunPickup'
}
