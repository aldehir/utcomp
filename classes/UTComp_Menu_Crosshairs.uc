...
defaultproperties
{
   ...
   Begin Object class=moCheckBox name=SizeIncreaseCheck
    ...
    UTCompNewHairs(0)=(xHairName="Big Circle(0)",xHairTexture=Texture'UTCompv17asrc.BigCircle')
    UTCompNewHairs(1)=(xHairName="Big Circle(1)",xHairTexture=Texture'UTCompv17asrc.MedCircle')
    UTCompNewHairs(2)=(xHairName="Big Circle(2)",xHairTexture=Texture'UTCompv17asrc.SmallCircle')
    UTCompNewHairs(3)=(xHairName="Big Circle(3)",xHairTexture=Texture'UTCompv17asrc.UberSmallCircle')

    UTCompNewHairs(4)=(xHairName="Small Circle(0)",xHairTexture=Texture'UTCompv17asrc.BigCircle_2')
    UTCompNewHairs(5)=(xHairName="Small Circle(1)",xHairTexture=Texture'UTCompv17asrc.MedCircle_2')
    UTCompNewHairs(6)=(xHairName="Small Circle(2)",xHairTexture=Texture'UTCompv17asrc.SmallCircle_2')
    UTCompNewHairs(7)=(xHairName="Small Circle(3)",xHairTexture=Texture'UTCompv17asrc.UberSmallCircle_2')

    UTCompNewHairs(8)=(xHairName="Big Square(0)",xHairTexture=Texture'UTCompv17asrc.BigSquare')
    UTCompNewHairs(9)=(xHairName="Big Square(1)",xHairTexture=Texture'UTCompv17asrc.BigSquare_2')
    UTCompNewHairs(10)=(xHairName="Big Square(2)",xHairTexture=Texture'UTCompv17asrc.BigSquare_3')

    UTCompNewHairs(11)=(xHairName="Big diamond(0)",xHairTexture=Texture'UTCompv17asrc.Bigdiamond')
    UTCompNewHairs(12)=(xHairName="Big Diamond(1)",xHairTexture=Texture'UTCompv17asrc.Bigdiamond_2')
    UTCompNewHairs(13)=(xHairName="Big Diamond(2)",xHairTexture=Texture'UTCompv17asrc.Bigdiamond_3')

    UTCompNewHairs(14)=(xHairName="Big Horiz",xHairTexture=Texture'UTCompv17asrc.SmallVert')
    UTCompNewHairs(15)=(xHairName="Small Horiz",xHairTexture=Texture'UTCompv17asrc.BigVert')
    UTCompNewHairs(16)=(xHairName="Big Vert",xHairTexture=Texture'UTCompv17asrc.SmallHoriz')
    UTCompNewHairs(17)=(xHairName="Small Vert",xHairTexture=Texture'UTCompv17asrc.BigHoriz')

    UTCompNewHairs(18)=(xHairName="Big 'L'(0)",xHairTexture=Texture'UTCompv17asrc.BigBracket')
    UTCompNewHairs(19)=(xHairName="Big 'L'(1)",xHairTexture=Texture'UTCompv17asrc.BigBracket_1')
    UTCompNewHairs(20)=(xHairName="Big 'L'(2)",xHairTexture=Texture'UTCompv17asrc.BigBracket_2')
    UTCompNewHairs(21)=(xHairName="Big 'L'(3)",xHairTexture=Texture'UTCompv17asrc.BigBracket_3')
    UTCompNewHairs(22)=(xHairName="Big 'L'(4)",xHairTexture=Texture'UTCompv17asrc.BigBracket_4')
    UTCompNewHairs(23)=(xHairName="Big 'L'(5)",xHairTexture=Texture'UTCompv17asrc.BigBracket_5')
    UTCompNewHairs(24)=(xHairName="Big 'L'(6)",xHairTexture=Texture'UTCompv17asrc.BigBracket_6')
    UTCompNewHairs(25)=(xHairName="Big 'L'(7)",xHairTexture=Texture'UTCompv17asrc.BigBracket_7')
