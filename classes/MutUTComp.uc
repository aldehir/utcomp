...
#exec OBJ LOAD FILE=minimegatex.utx PACKAGE=UTCompv17c
...
function SetupColoredDeathMessages()
{
    if(Level.Game.DeathMessageClass==class'xGame.xDeathMessage')
        Level.Game.DeathMessageClass=class'UTCompv17c.UTComp_xDeathMessage';
    else if(Level.Game.DeathMessageClass==Class'SkaarjPack.InvasionDeathMessage')
        Level.Game.DeathMessageClass=class'UTCompv17c.UTComp_InvasionDeathMessage';
}
...
function SetupStats()
{
    ...
    class'xWeapons.AssaultRifle'.default.FireModeClass[0] = Class'UTCompv17c.UTComp_AssaultFire';
    class'xWeapons.AssaultRifle'.default.FireModeClass[1] = Class'UTCompv17c.UTComp_AssaultGrenade';

    class'xWeapons.BioRifle'.default.FireModeClass[0] = Class'UTCompv17c.UTComp_BioFire';
    class'xWeapons.BioRifle'.default.FireModeClass[1] = Class'UTCompv17c.UTComp_BioChargedFire';

    class'xWeapons.ShockRifle'.default.FireModeClass[0] = Class'UTCompv17c.UTComp_ShockBeamFire';
    class'xWeapons.ShockRifle'.default.FireModeClass[1] = Class'UTCompv17c.UTComp_ShockProjFire';

    class'xWeapons.LinkGun'.default.FireModeClass[0] = Class'UTCompv17c.UTComp_LinkAltFire';
    class'xWeapons.LinkGun'.default.FireModeClass[1] = Class'UTCompv17c.UTComp_LinkFire';

    class'xWeapons.MiniGun'.default.FireModeClass[0] = Class'UTCompv17c.UTComp_MinigunFire';
    class'xWeapons.MiniGun'.default.FireModeClass[1] = Class'UTCompv17c.UTComp_MinigunAltFire';

    class'xWeapons.FlakCannon'.default.FireModeClass[0] = Class'UTCompv17c.UTComp_FlakFire';
    class'xWeapons.FlakCannon'.default.FireModeClass[1] = Class'UTCompv17c.UTComp_FlakAltFire';

    class'xWeapons.RocketLauncher'.default.FireModeClass[0] = Class'UTCompv17c.UTComp_RocketFire';
    class'xWeapons.RocketLauncher'.default.FireModeClass[1] = Class'UTCompv17c.UTComp_RocketMultiFire';

    class'xWeapons.SniperRifle'.default.FireModeClass[0]= Class'UTCompv17c.UTComp_SniperFire';
    class'UTClassic.ClassicSniperRifle'.default.FireModeClass[0]= Class'UTCompv17c.UTComp_ClassicSniperFire';

    class'Onslaught.ONSMineLayer'.default.FireModeClass[0] = Class'UTCompv17c.UTComp_ONSMineThrowFire';

    class'Onslaught.ONSGrenadeLauncher'.default.FireModeClass[0] =Class'UTCompv17c.UTComp_ONSGrenadeFire';

    class'OnsLaught.ONSAvril'.default.FireModeClass[0] =Class'UTCompv17c.UTComp_ONSAvrilFire';

    class'xWeapons.SuperShockRifle'.default.FireModeClass[0]=class'UTCompv17c.UTComp_SuperShockBeamFire';
    class'xWeapons.SuperShockRifle'.default.FireModeClass[1]=class'UTCompv17c.UTComp_SuperShockBeamFire';
...
simulated function Tick(float DeltaTime)
{
    ...
    if(PC!=None)
    {
        PC.Player.InteractionMaster.AddInteraction("UTCompv17c.UTComp_Overlay", PC.Player);
...
function ReplacePawnAndPC()
{
    if(Level.Game.DefaultPlayerClassName~="xGame.xPawn")
        Level.Game.DefaultPlayerClassName="UTCompv17c.UTComp_xPawn";
    if(class'xPawn'.default.ControllerClass==class'XGame.XBot') //bots don't skin otherwise
        class'xPawn'.default.ControllerClass=class'UTCompv17c.UTComp_xBot';

    Level.Game.PlayerControllerClassName="UTCompv17c.BS_xPlayer";
}
...
function PostBeginPlay()
{
    ...
    SetupWarmup();
    if(bForward)
        Level.Game.AddMutator("utcompv17c.Forward_Mutator", true);
...
function ModifyLogin(out string Portal, out string Options)
{
	...
	if (bSeeAll && bSpectator) {
		...
		Level.Game.PlayerControllerClassName = "UTCompv17c.UTV_BS_xPlayer";
    ...
    if(Level.Game.ScoreBoardType~="xInterface.ScoreBoardDeathMatch")
    {
        if(bEnableScoreBoard)
            Level.Game.ScoreBoardType="UTCompv17c.UTComp_ScoreBoard";
        else
            Level.Game.ScoreBoardType="UTCompv17c.UTComp_ScoreBoardDM";
    }
    else if(Level.Game.ScoreBoardType~="xInterface.ScoreBoardTeamDeathMatch")
    {
        if(bEnableScoreBoard)
            ...
            Level.Game.ScoreBoardType="UTCompv17c.UTComp_ScoreBoardTDM";
    }
    else if(Level.Game.ScoreBoardType~="UT2k4Assault.ScoreBoard_Assault")
    {
        Level.Game.ScoreBoardType="UTCompv17c.UTComp_ScoreBoard_AS";
    }
    else if(Level.game.scoreboardtype~="BonusPack.MutantScoreboard")
    {
        Level.Game.ScoreBoardType="UTCompv17c.UTComp_ScoreBoard_Mutant";
    }
/*   else if(Level.Game.ScoreBoardType~="BonusPack.ScoreBoardLMS")
    {
         Level.Game.ScoreBoardType="UTCompv17c.UTComp_ScoreBoard_LMS";
    }  */

    Super.ModifyLogin(Portal, Options);

    if(level.game.hudtype~="xInterface.HudCTeamDeathmatch")
        Level.Game.HudType="UTCompv17c.UTComp_HudCTeamDeathmatch";
    else if(level.game.hudtype~="xInterface.HudCDeathmatch")
        Level.Game.HudType="UTCompv17c.UTComp_HudCDeathmatch";
    else if(level.game.hudtype~="xInterface.HudCBombingRun")
        Level.Game.HudType="UTCompv17c.UTComp_HudCBombingRun";
    else if(level.game.hudtype~="xInterface.HudCCaptureTheFlag")
        Level.Game.HudType="UTCompv17c.UTComp_HudCCaptureTheFlag";
    else if(level.game.hudtype~="xInterface.HudCDoubleDomination")
        Level.Game.HudType="UTCompv17c.UTComp_HudCDoubleDomination";
    else if(level.game.hudtype~="Onslaught.ONSHUDOnslaught")
        Level.Game.HudType="UTCompv17c.UTComp_ONSHUDOnslaught";
    else if(level.game.hudtype~="SkaarjPack.HudInvasion")
        Level.Game.HudType="UTCompv17c.UTComp_HudInvasion";
    else if(level.game.hudtype~="BonusPack.HudLMS")
        Level.Game.HudType="UTCompv17c.UTComp_HudLMS";
    else if(level.game.hudtype~="BonusPack.HudMutant")
        Level.Game.HudType="UTCompv17c.UTComp_HudMutant";
    else if(level.game.hudtype~="ut2k4assault.Hud_Assault")
        Level.Game.HudType="UTCompv17c.UTComp_Hud_Assault";
}
...
{
    if(class'UTCompv17c.MutUTComp'.default.bEnableAutoDemorec)
    {
...
{
    local string S;
    S=class'UTCompv17c.MutUTComp'.default.AutoDemoRecMask;
...
function GetServerDetails( out GameInfo.ServerResponseLine ServerState )
{
	...
	ServerState.ServerInfo[i].Value = "1.7c";
...
defaultproperties
{
     ...
     ServerMaxPlayers=12
     AlwaysUseThisMutator(0)="UTCompv17c.mututcomp"
     ...
     VotingGametype(5)=(GametypeOptions="?game=UTCompv17c.UTComp_ClanArena?goalscore=7?TimeLimit=2?FriendlyFireScale=0?GrenadesOnSpawn=4?TimedOverTimeLength=0",GametypeName="Clan Arena")
     ...
     FriendlyName="UTComp Version 1.7c"
     ...
     WeaponClasses(0)=Class'UTCompv17c.NewNet_ShockRifle'
     WeaponClasses(1)=Class'UTCompv17c.NewNet_LinkGun'
     WeaponClasses(2)=Class'UTCompv17c.NewNet_MiniGun'
     WeaponClasses(3)=Class'UTCompv17c.NewNet_FlakCannon'
     WeaponClasses(4)=Class'UTCompv17c.NewNet_RocketLauncher'
     WeaponClasses(5)=Class'UTCompv17c.NewNet_SniperRifle'
     WeaponClasses(6)=Class'UTCompv17c.NewNet_BioRifle'
     WeaponClasses(7)=Class'UTCompv17c.NewNet_AssaultRifle'
     WeaponClasses(8)=Class'UTCompv17c.NewNet_ClassicSniperRifle'
     WeaponClasses(9)=Class'UTCompv17c.NewNet_ONSAVRiL'
     WeaponClasses(10)=Class'UTCompv17c.NewNet_ONSMineLayer'
     WeaponClasses(11)=Class'UTCompv17c.NewNet_ONSGrenadeLauncher'
     ...
     WeaponPickupClasses(0)=Class'UTCompv17c.NewNet_ShockRiflePickup'
     WeaponPickupClasses(1)=Class'UTCompv17c.NewNet_LinkGunPickup'
     WeaponPickupClasses(2)=Class'UTCompv17c.NewNet_MiniGunPickup'
     WeaponPickupClasses(3)=Class'UTCompv17c.NewNet_FlakCannonPickup'
     WeaponPickupClasses(4)=Class'UTCompv17c.NewNet_RocketLauncherPickup'
     WeaponPickupClasses(5)=Class'UTCompv17c.NewNet_SniperRiflePickup'
     WeaponPickupClasses(6)=Class'UTCompv17c.NewNet_BioRiflePickup'
     WeaponPickupClasses(7)=Class'UTCompv17c.NewNet_AssaultRiflePickup'
     WeaponPickupClasses(8)=Class'UTCompv17c.NewNet_ClassicSniperRiflePickup'
     WeaponPickupClasses(9)=Class'UTCompv17c.NewNet_ONSAVRiLPickup'
     WeaponPickupClasses(10)=Class'UTCompv17c.NewNet_ONSMineLayerPickup'
     WeaponPickupClasses(11)=Class'UTCompv17c.NewNet_ONSGrenadePickup'
     WeaponPickupClassNames(0)="UTCompv17c.NewNet_ShockRiflePickup"
     WeaponPickupClassNames(1)="UTCompv17c.NewNet_LinkGunPickup"
     WeaponPickupClassNames(2)="UTCompv17c.NewNet_MiniGunPickup"
     WeaponPickupClassNames(3)="UTCompv17c.NewNet_FlakCannonPickup"
     WeaponPickupClassNames(4)="UTCompv17c.NewNet_RocketLauncherPickup"
     WeaponPickupClassNames(5)="UTCompv17c.NewNet_SniperRiflePickup"
     WeaponPickupClassNames(6)="UTCompv17c.NewNet_BioRiflePickup"
     WeaponPickupClassNames(7)="UTCompv17c.NewNet_AssaultRiflePickup"
     WeaponPickupClassNames(8)="UTCompv17c.NewNet_ClassicSniperRiflePickup"
     WeaponPickupClassNames(9)="UTCompv17c.NewNet_ONSAVRiLPickup"
     WeaponPickupClassNames(10)="UTCompv17c.NewNet_ONSMineLayerPickup"
     WeaponPickupClassNames(11)="UTCompv17c.NewNet_ONSGrenadePickup"
