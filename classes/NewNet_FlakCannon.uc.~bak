...
defaultproperties
{
    FireModeClass(0)=class'UTCompv17c.NewNet_FlakFire'
    FireModeClass(1)=class'UTCompv17c.NewNet_FlakAltFire'
    PickupClass=Class'UTCompv17c.NewNet_FlakCannonPickup'
}
