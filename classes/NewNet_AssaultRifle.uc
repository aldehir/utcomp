...
DefaultProperties
{
    FireModeClass(0)=class'UTCompv17asrc.NewNet_AssaultFire'
    FireModeClass(1)=class'UTCompv17asrc.NewNet_AssaultGrenade'
    PickupClass=Class'UTCompv17asrc.NewNet_AssaultRiflePickup'
}
