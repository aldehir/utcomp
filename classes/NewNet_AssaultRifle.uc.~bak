...
DefaultProperties
{
    FireModeClass(0)=class'UTCompv17b.NewNet_AssaultFire'
    FireModeClass(1)=class'UTCompv17b.NewNet_AssaultGrenade'
    PickupClass=Class'UTCompv17b.NewNet_AssaultRiflePickup'
}
