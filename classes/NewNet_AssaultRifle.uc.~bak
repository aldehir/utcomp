...
DefaultProperties
{
    FireModeClass(0)=class'UTCompv17c.NewNet_AssaultFire'
    FireModeClass(1)=class'UTCompv17c.NewNet_AssaultGrenade'
    PickupClass=Class'UTCompv17c.NewNet_AssaultRiflePickup'
}
