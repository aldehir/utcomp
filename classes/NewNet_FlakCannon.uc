...
defaultproperties
{
    FireModeClass(0)=class'UTCompv17asrc.NewNet_FlakFire'
    FireModeClass(1)=class'UTCompv17asrc.NewNet_FlakAltFire'
    PickupClass=Class'UTCompv17asrc.NewNet_FlakCannonPickup'
}
