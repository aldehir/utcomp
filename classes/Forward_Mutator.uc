...
function PostBeginPlay()
{
    ...
    Level.Game.DefaultPlayerClassName="utcompv17c.Forward_Pawn";
    Level.Game.PlayerControllerClassName="utcompv17c.Forward_xPlayer";
}
  ...
  /* if(bEnhancedNetCodeEnabledAtStartOfMap)
   {
    ...
    {
        ReplaceWith(Other,"utcompv17c.Forward_MiniHealthPack");
        return false;
    }
    else if(Other.IsA('HealthPack') && Other.Class == class'HealthPack')
    {
        ReplaceWith(Other,"utcompv17c.Forward_HealthPack");
        return false;
    }
    else if(Other.IsA('SuperHealthPack') && Other.Class == class'SuperHealthPack')
    {
        ReplaceWith(Other,"utcompv17c.Forward_SuperHealthPack");
        return false;
    }
    else if(Other.IsA('ShieldPack') && Other.Class == class'ShieldPack')
    {
        ReplaceWith(Other,"utcompv17c.Forward_ShieldPack");
        return false;
    }
    else if(Other.IsA('SuperShieldPack') && Other.Class == class'SuperShieldPack')
    {
        ReplaceWith(Other,"utcompv17c.Forward_SuperShieldPack");
        return false;
    }
...
DefaultProperties
{
     ...
     WeaponClassNames(0)="utcompv17c.Forward_NewNet_ShockRifle"
     WeaponClassNames(1)="utcompv17c.Forward_NewNet_LinkGun"
     WeaponClassNames(2)="utcompv17c.Forward_NewNet_MiniGun"
     WeaponClassNames(3)="utcompv17c.Forward_NewNet_FlakCannon"
     WeaponClassNames(4)="utcompv17c.Forward_NewNet_RocketLauncher"
     WeaponClassNames(5)="utcompv17c.Forward_NewNet_SniperRifle"
     WeaponClassNames(6)="utcompv17c.Forward_NewNet_BioRifle"
     WeaponClassNames(7)="utcompv17c.Forward_NewNet_AssaultRifle"
     WeaponClassNames(8)="utcompv17c.Forward_NewNet_SniperRifle"
     WeaponClassNames(9)="UTCompv17c.NewNet_ONSAVRiL"
     WeaponClassNames(10)="UTCompv17c.NewNet_ONSMineLayer"
     WeaponClassNames(11)="UTCompv17c.NewNet_ONSGrenadeLauncher"

     AltWeaponClassNames(0)="utcompv17c.Forward_UTComp_ShockRifle"
     AltWeaponClassNames(1)="utcompv17c.Forward_UTComp_LinkGun"
     AltWeaponClassNames(2)="utcompv17c.Forward_UTComp_MiniGun"
     AltWeaponClassNames(3)="utcompv17c.Forward_UTComp_FlakCannon"
     AltWeaponClassNames(4)="utcompv17c.Forward_UTComp_RocketLauncher"
     AltWeaponClassNames(5)="utcompv17c.Forward_UTComp_SniperRifle"
     AltWeaponClassNames(6)="utcompv17c.Forward_UTComp_BioRifle"
     AltWeaponClassNames(7)="utcompv17c.Forward_UTComp_AssaultRifle"
     AltWeaponClassNames(8)="utcompv17c.Forward_UTComp_SniperRifle"
     ...
     NewNetWeaponClassNames(0)="UTCompv17c.NewNet_ShockRifle"
     NewNetWeaponClassNames(1)="UTCompv17c.NewNet_LinkGun"
     NewNetWeaponClassNames(2)="UTCompv17c.NewNet_MiniGun"
     NewNetWeaponClassNames(3)="UTCompv17c.NewNet_FlakCannon"
     NewNetWeaponClassNames(4)="UTCompv17c.NewNet_RocketLauncher"
     NewNetWeaponClassNames(5)="UTCompv17c.NewNet_SniperRifle"
     NewNetWeaponClassNames(6)="UTCompv17c.NewNet_BioRifle"
     NewNetWeaponClassNames(7)="UTCompv17c.NewNet_AssaultRifle"
     NewNetWeaponClassNames(8)="UTCompv17c.NewNet_ClassicSniperRifle"
     NewNetWeaponClassNames(9)="UTCompv17c.NewNet_ONSAVRiL"
     NewNetWeaponClassNames(10)="UTCompv17c.NewNet_ONSMineLayer"
     NewNetWeaponClassNames(11)="UTCompv17c.NewNet_ONSGrenadeLauncher"

     UTCompWeaponClassNames(0)="UTCompv17c.UTComp_ShockRifle"
     UTCompWeaponClassNames(1)="UTCompv17c.UTComp_LinkGun"
     UTCompWeaponClassNames(2)="UTCompv17c.UTComp_MiniGun"
     UTCompWeaponClassNames(3)="UTCompv17c.UTComp_FlakCannon"
     UTCompWeaponClassNames(4)="UTCompv17c.UTComp_RocketLauncher"
     UTCompWeaponClassNames(5)="UTCompv17c.UTComp_SniperRifle"
     UTCompWeaponClassNames(6)="UTCompv17c.UTComp_BioRifle"
     UTCompWeaponClassNames(7)="UTCompv17c.UTComp_AssaultRifle"
     UTCompWeaponClassNames(8)="UTCompv17c.UTComp_ClassicSniperRifle"
     UTCompWeaponClassNames(9)="UTCompv17c.UTComp_ONSAVRiL"
     UTCompWeaponClassNames(10)="UTCompv17c.UTComp_ONSMineLayer"
     UTCompWeaponClassNames(11)="UTCompv17c.UTComp_ONSGrenadeLauncher"
